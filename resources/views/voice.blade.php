    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p class="offers ">TeamSpeak 3 offers the ideal tool for online gaming, education and training, internal business communication, and staying in touch with friends and family.  TeamSpeak 3 is literally capable of handling up to thousands of simultaneous use</p>
            </div>
...
<section class="exclusive_services">
    ...
    <div class="row">
        <div class="col">
            <h1 class="plans text-center mb-0 mt-5 text-light"> Our <span class="text-warning">Booking</span> Slots</h1>
        </div>
    </div>
       <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="text_content  text-light pt-5 ">
                    <h1 class="text_title ">The Best List-Making <span class="text-warning">Apps for Voice Commands.</span> </h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="customer_dec text-center mt-5">
                    <h2 class="customer_title text-light">our Customer's <span class="text-warning"> views</span></h2>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="customer_details">
                                    ...
                                    src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(10).webp" class="text-center" alt="avatar"
                                    style="width: 150px;" />
                                </div>
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="col-lg-8">
                                    <div class="text-center mt-2">
                                        ...
                                        <i class="fas fa-quote-left pe-2"></i>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus et deleniti
                                        nesciunt sint eligendi reprehenderit reiciendis. Consectetur distinctio fugit
                                        doloremque.
                                        </p>
                                    </div>
                                </div>
