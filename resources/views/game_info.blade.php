                ...
                <div class="image">
                    <div class="row">
                        <div class="col-md-12 my-5 text-center">
                            <h1 class="manage1">7<span> DAYS TO DIE </span> SERVER </h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="games-info">
        <div class="container">
            <div class="WELCOME">
                ...
                <h3 style="font-weight: 800;">7 DAYS TO DIE<span class="info"> SERVER </span> </h3>
                ...
                <h3 class="mt-5" style="font-weight: 800;">GAMES CONTROLLER <span class="info"> SYSTEM </span> </h3>
                <p>Donec orci enim, bibendum a augue quis, aliquet cursus quam. Pellentesque pulvinar, elit at
                    condimentum dictum, sapien nibh auctor tortoris vulputate sapien tortor et velit. Sed nulla nisi,
                    congue eu quam vel, molestie grvida ipsum. Curabitr ut lacus vitae tellus lacinia pretium. Proin
                    vestibulum sollcitudin tortor, quis auctor mi rutrum non. Donec non eros eget purus lobortis
