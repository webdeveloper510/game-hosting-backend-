...
section.hosting{
    background-image: url(./assets/images/bg-hosting.webp);
            ...
            <div class="row">
                <div class="col-md-12 mt-4 text-center">
                    ...
                    <div class="text-center d-flex justify-content-end mx-5 ">
                        ...
                        <div class="pt-2 ">
                            <h5 class="text-light"><img src="./assets/images/longarrow.webp" class="me-2"><strong class="text-primary me-2">SAVE 12%</strong>BY PAYING ANNUALLY</h5>
                        </div>  
    ...
    <section class="pakeges">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="./assets/images/instant.webp" class="" alt="">
                ...
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="./assets/images/support.webp" class="" alt="">
                ...
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="./assets/images/backups.webp" class="" alt="">
                ...
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="./assets/images/ssd.webp" class="" alt="">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="./assets/images/included.webp" class="" alt="">
                ...
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="./assets/images/ddossss.webp" class="" alt="">
                ...
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="./assets/images/spamprotection.webp" class="">
                ...
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="./assets/images/sla.webp" class="" alt="">
                ...
                <div class="col-md-6">
                    <div class="logo_images ">
                        <div class="row"> 
                            <div class="col-md-4">
                                <div class="">
                                    <img src="./assets/images/wordpress.webp" class="mb-5 mt-3" alt="">
                                    <div class="tooltip">WordPress</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <img src="./assets/images/joomla.webp" class="mt-3" alt="">
                                <div class="tooltip">Joomla</div>
                            </div>
                            <div class="col-md-4">
                                <img src="./assets/images/magento.webp" class="mt-3" alt="">
                                <div class="tooltip">Magento</div>
                            </div> 
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <img src="./assets/images/drupal.webp" class="mt-5" alt="">
                                <div class="tooltip">Drupal</div>
                            </div>
                            <div class="col-md-4">
                                <img src="./assets/images/xmod.webp" class="mt-5" alt="">
                                <div class="tooltip">X Mod</div>
                            </div>
                            <div class="col-md-4">
                                <img src="./assets/images/mybb.webp" class="mt-5" alt="">
            ...
            <div class="row">   
                <div class="col-md-6">
                    <div class="computer_img">
                        <img src="./assets/images/cpanel.webp" class="cpanal " alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="panal_control">
                        ...
                        <div class="row">
                            <div class="col-md-6">                        
                                    <p class="full mb-0 text-light"><img src="./assets/images/bluetick.webp" class="me-2" alt="">Full FTP Access</p>
                                    <p class="full text-light"><img src="./assets/images/bluetick.webp" class="me-2" alt="">Multiple PHP Versions</p>                        
                            </div>
                            <div class="col-md-6">   
                                    <p class="full mb-0 text-light"><img src="./assets/images/bluetick.webp" class="me-2" alt="">Enable/disable moduless</p>
                                    <p class="full text-light"><img src="./assets/images/bluetick.webp" class="me-2" alt="">View statistics and errors</p>
                            </div>
                        </div>
                </div>
                </div>
