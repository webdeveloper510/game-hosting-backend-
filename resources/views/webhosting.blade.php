            ...
            <div class="row">
                <div class="col-md-12 mt-4 text-center">
                    ...
                    <div class="text-center d-flex justify-content-end mx-5 ">
                        ...
                        <div class="pt-2 ">
                            <h5 class="text-light"><img src="<?php echo URL::to('/'); ?>/public/assets/images/longarrow.webp"
                                    class="me-2"><strong class="text-primary me-2">SAVE 12%</strong>BY PAYING
                                ANNUALLY</h5>
                        </div>
                ...
                <div class="row g-4 my-1">
                    <div class="col-md-3 ">
                        <div class="price_rate  text-center  mt-3">
                            ...
                            <a href="" type="button" class="btn btn-primary col-md-6  order  mb-2">Order
                                Now</a>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="<?php echo URL::to('/'); ?>/public/assets/images/instant.webp" class=""
                            alt="">
                        <h4 class="instant mt-4">INSTANT ACTIVATION</h4>
                        <p class="text-secondary">Your website will be activated and ready for use within 5 seconds
                            following receipt of payment.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="<?php echo URL::to('/'); ?>/public/assets/images/support.webp" class=""
                            alt="">
                        <h4 class="instant mt-4">24/7 TECH SUPPORT</h4>
                        <p class="text-secondary"> Our technical support team is available to assist with your web
                            hosting service at any time, any day.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="<?php echo URL::to('/'); ?>/public/assets/images/backups.webp" class=""
                            alt="">
                        <h4 class=" instant mt-4">OFFSITE BACKUPS</h4>
                        <p class="text-secondary">We automatically back up all of your configurations, content and
                            databases to an offsite platform.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        ...
                        <p class="text-secondary">Websites and databases simply perform better on SSDs. We only use
                            NVMe SSDs in our web hosting nodes.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="<?php echo URL::to('/'); ?>/public/assets/images/included.webp" class=""
                            alt="">
                        <h4 class="instant mt-4">99.9% UPTIME GUARANTEE</h4>
                        <p class="text-secondary">We guarantee the uptime of your service. Any downtime will be
                            credited with account credit.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        <img src="<?php echo URL::to('/'); ?>/public/assets/images/ddossss.webp" class=""
                            alt="">
                        <h4 class="instant mt-4">PROTECTED BY CLOUDFLARE</h4>
                        <p class="text-secondary">We protect your website against DDoS attacks and exploits. As a
                            Cloudflare partner, we'll keep you online 24/7.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        ...
                        <p class="text-secondary">Our system automatically monitors mail activity to block spammers,
                            keeping our IPs off blacklists.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-center mt-4">
                        ...
                        <p class="text-secondary">As with all of our services, we'll give you your money back within 72
                            hours if you're not happy.</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="p-5">
                        ...
                        <p class="need_experienced mb-2 text-light">You don't need to be an experienced webmaster to
                            run a website. Instantly install software, scripts and full content management systems in
                            just a couple of clicks using Softaculous.</p>
                ...
                <div class="col-md-6">
                    <div class="logo_images ">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="">
                                    <img src="<?php echo URL::to('/'); ?>/public/assets/images/wordpress.webp"
                                        class="mb-5 mt-3" alt="">
                                    <div class="tooltip">WordPress</div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <img src="<?php echo URL::to('/'); ?>/public/assets/images/joomla.webp" class="mt-3"
                                    alt="">
                                <div class="tooltip">Joomla</div>
                            </div>
                            <div class="col-md-4">
                                <img src="<?php echo URL::to('/'); ?>/public/assets/images/magento.webp" class="mt-3"
                                    alt="">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <img src="<?php echo URL::to('/'); ?>/public/assets/images/drupal.webp" class="mt-5"
                                    alt="">
                                <div class="tooltip">Drupal</div>
                            </div>
                            <div class="col-md-4">
                                <img src="<?php echo URL::to('/'); ?>/public/assets/images/xmod.webp" class="mt-5"
                                    alt="">
                                <div class="tooltip">X Mod</div>
                            </div>
                            <div class="col-md-4">
                                <img src="<?php echo URL::to('/'); ?>/public/assets/images/mybb.webp" class="mt-5"
                                    alt="">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="computer_img">
                        <img src="<?php echo URL::to('/'); ?>/public/assets/images/cpanel.webp" class="cpanal "
                            alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="panal_control">
                        ...
                        <p class="need_experienced text-light">The industry standard in web hosting control. You won't
                            find an easier way to manage your websites.</p>
                        <div class="row">
                            <div class="col-md-6">
                                <p class="full mb-0 text-light"><img
                                        src="<?php echo URL::to('/'); ?>/public/assets/images/bluetick.webp" class="me-2"
                                        alt="">Full FTP Access</p>
                                <p class="full text-light"><img
                                        src="<?php echo URL::to('/'); ?>/public/assets/images/bluetick.webp" class="me-2"
                                        alt="">Multiple PHP Versions</p>
                            </div>
                            <div class="col-md-6">
                                <p class="full mb-0 text-light"><img
                                        src="<?php echo URL::to('/'); ?>/public/assets/images/bluetick.webp" class="me-2"
                                        alt="">Enable/disable moduless</p>
                                <p class="full text-light"><img
                                        src="<?php echo URL::to('/'); ?>/public/assets/images/bluetick.webp" class="me-2"
                                        alt="">View statistics and errors</p>
                            </div>
                        </div>
                    </div>
                </div>
